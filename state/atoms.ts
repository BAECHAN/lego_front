...
const deliveryRequestAtom = atom<string[]>({
  key: `deliveryRequestAtom`,
  default: [
    '배송 시 요청사항을 선택해주세요',
    '부재 시 경비실에 맡겨주세요',
    '부재 시 택배함에 넣어주세요',
...
export const deliveryRequestSelector = selector({
  key: `deliveryRequestSelector`,
  get: ({ get }) => {
    return get(deliveryRequestAtom)
  },
})
